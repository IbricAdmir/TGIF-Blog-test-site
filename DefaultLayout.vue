...
const user = {
  name: 'Admir Ibric',
  email: 'Admir@TheBoss.com',
  imageUrl: 'https://at-cdn-s03.audiotool.com/2021/02/18/documents/4e9c0igjga/0/cover256x256-095976c9e3ea4816a917d5d8b31d353d.jpg'
}
const navigation = [
  { name: 'Dashboard', href: '#', current: true },
  { name: 'Artwork', href: '#', current: false },
